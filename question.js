var test1 =[
    {
        "q":"456先生在吃韓式魷魚泡麵，一不小心把整碗熱湯灑在大腿上了。請問，有關燙傷五字訣(沖脫泡蓋送)中的「沖」，以下敘述何者正確？",
...
var test3 =[
    ...
    },
    {
        ...
        "ans":0,
        "hint":"<b style='color:#BE3433'>【健康知識】</b><br>戴口罩目的是為了有效防堵及預防傳染病的傳播。<br>口罩正確配戴步驟：開(打開)、戴(戴上)、壓(輕壓鼻樑片)、密(確認密合度)。"
    },
    {
...
var test7 =[
    ...
    },
    {
        ...
        "Options_C":"開、貼、插、電",
        "ans":2,
        "hint":"<b style='color:#BE3433'>【健康知識】</b><br>AED 使用口訣：開(打開 AED 電源)、貼(貼上 2 片電擊貼片)、插(插上導線插座)、電(評估是否電擊)。2 片電擊貼片位置：患者左邊乳頭下方偏外側處(左下)及右邊乳頭上方(右上)。"
    },
    {
        ...
        "Options_C":"15",
        "ans":2,
        "hint":"<b style='color:#BE3433'>【健康知識】</b><br>中原大學共有 15 台 AED，位於：維澈樓、教學大樓、電學大樓、恩慈宿舍、設計學院(望樓)、工學館、商學院、理學大樓、圖書館、衛保組、力行宿舍、體育館、薄膜中心、信實宿舍、熱誠宿舍"
    },
]
...
var num7 = Math.floor(Math.random()*3);
